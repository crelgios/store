-- Aliwvide Store Supabase Schema
...
('Rose Gold Chikankari Lawn Suit', 'rose-gold-chikankari-lawn-suit', 'Women', 'Pakistani Suits', 'Soft rose gold lawn suit with chikankari-style embroidery and a light dupatta for daily elegance.', 2199, 3599, array['XS','S','M','L','XL'], array['Rose Gold','Cream'], array['/suits/pastel-pink-suit.jpg'], 18, 'published'),
('Navy Blue Mirror Work Suit Set', 'navy-blue-mirror-work-suit-set', 'Women', 'Pakistani Suits', 'Navy blue Pakistani suit with mirror work inspired detailing, perfect for evening gatherings and festive wear.', 2999, 4799, array['S','M','L','XL','XXL'], array['Navy Blue','Silver'], array['/suits/black-party-suit.jpg'], 11, 'published'),
('Mint Green Printed Lawn Suit', 'mint-green-printed-lawn-suit', 'Women', 'Pakistani Suits', 'Fresh mint green printed lawn suit with a breezy dupatta for summer, casual outings, and comfortable styling.', 1899, 2999, array['XS','S','M','L','XL'], array['Mint Green','White'], array['/suits/sage-lawn-suit.jpg'], 22, 'published'),
('Royal Blue Embroidered Straight Suit', 'royal-blue-embroidered-straight-suit', 'Women', 'Pakistani Suits', 'Royal blue straight suit with neat embroidery and a graceful dupatta for semi-formal and festive occasions.', 2799, 4499, array['S','M','L','XL'], array['Royal Blue'], array['/suits/lavender-suit.jpg'], 14, 'published'),
('Peach Organza Festive Suit Set', 'peach-organza-festive-suit-set', 'Women', 'Pakistani Suits', 'Peach festive suit set with organza-style dupatta and delicate embroidery for family functions and celebrations.', 3199, 5199, array['S','M','L','XL','XXL'], array['Peach','Gold'], array['/suits/ivory-straight-suit.jpg'], 9, 'published'),
('Teal Green Palazzo Suit Set', 'teal-green-palazzo-suit-set', 'Women', 'Pakistani Suits', 'Teal green palazzo suit set with a comfortable fit, embroidered accents, and a matching dupatta.', 2599, 3999, array['S','M','L','XL'], array['Teal Green'], array['/suits/maroon-palazzo-suit.jpg'], 13, 'published'),
('White Cotton Daily Wear Suit', 'white-cotton-daily-wear-suit', 'Women', 'Pakistani Suits', 'Clean white cotton suit set made for simple everyday comfort with a soft dupatta and easy styling.', 1699, 2599, array['XS','S','M','L','XL','XXL'], array['White','Ivory'], array['/suits/ivory-straight-suit.jpg'], 25, 'published'),
('Mustard Yellow Anarkali Suit', 'mustard-yellow-anarkali-suit', 'Women', 'Pakistani Suits', 'Bright mustard yellow anarkali suit with festive embroidery and a flowy silhouette for a standout ethnic look.', 2899, 4599, array['S','M','L','XL'], array['Mustard Yellow'], array['/suits/yellow-anarkali.jpg'], 10, 'published'),
('Wine Red Embroidered Sharara Suit', 'wine-red-embroidered-sharara-suit', 'Women', 'Pakistani Suits', 'Wine red sharara suit with rich embroidery, designed for weddings, parties, and special festive nights.', 3499, 5999, array['S','M','L','XL','XXL'], array['Wine Red','Maroon'], array['/suits/maroon-palazzo-suit.jpg'], 7, 'published'),
('Sky Blue Printed Pakistani Suit', 'sky-blue-printed-pakistani-suit', 'Women', 'Pakistani Suits', 'Sky blue printed Pakistani suit with a soft look and relaxed fit for day events and comfortable wear.', 1999, 3199, array['XS','S','M','L','XL'], array['Sky Blue','White'], array['/suits/lavender-suit.jpg'], 19, 'published'),
('Olive Green Embroidered Suit Set', 'olive-green-embroidered-suit-set', 'Women', 'Pakistani Suits', 'Olive green embroidered suit set with classic styling and a matching dupatta for elegant everyday dressing.', 2399, 3799, array['S','M','L','XL','XXL'], array['Olive Green'], array['/suits/sage-lawn-suit.jpg'], 16, 'published'),
('Beige Thread Work Straight Suit', 'beige-thread-work-straight-suit', 'Women', 'Pakistani Suits', 'Beige straight suit with subtle thread work, ideal for office, casual occasions, and graceful modest styling.', 2299, 3499, array['XS','S','M','L','XL'], array['Beige','Cream'], array['/suits/ivory-straight-suit.jpg'], 20, 'published'),
('Black Gold Embroidered Suit Set', 'black-gold-embroidered-suit-set', 'Women', 'Pakistani Suits', 'Black suit set with gold embroidery details for party wear, festive evenings, and elegant occasions.', 3399, 5499, array['S','M','L','XL'], array['Black','Gold'], array['/suits/black-party-suit.jpg'], 8, 'published'),
('Coral Pink Lawn Suit With Dupatta', 'coral-pink-lawn-suit-with-dupatta', 'Women', 'Pakistani Suits', 'Coral pink lawn suit with soft embroidery and dupatta, made for a fresh feminine everyday look.', 2099, 3299, array['XS','S','M','L','XL'], array['Coral Pink','Peach'], array['/suits/pastel-pink-suit.jpg'], 17, 'published'),
('Emerald Green Festive Suit Set', 'emerald-green-festive-suit-set', 'Women', 'Pakistani Suits', 'Emerald green festive suit with detailed accents and a polished finish for parties and family events.', 3299, 5299, array['S','M','L','XL','XXL'], array['Emerald Green'], array['/suits/sage-lawn-suit.jpg'], 9, 'published'),
('Lilac Embroidered Cotton Suit', 'lilac-embroidered-cotton-suit', 'Women', 'Pakistani Suits', 'Lilac cotton suit with refined embroidery and a comfortable fit for semi-formal and casual wear.', 2199, 3499, array['XS','S','M','L','XL'], array['Lilac','Lavender'], array['/suits/lavender-suit.jpg'], 15, 'published'),
('Rust Orange Pakistani Suit Set', 'rust-orange-pakistani-suit-set', 'Women', 'Pakistani Suits', 'Rust orange Pakistani suit set with ethnic charm and a flattering fit for festive daytime occasions.', 2599, 4099, array['S','M','L','XL'], array['Rust Orange'], array['/suits/yellow-anarkali.jpg'], 12, 'published'),
('Cream Zari Work Suit Set', 'cream-zari-work-suit-set', 'Women', 'Pakistani Suits', 'Cream suit set with zari-style detailing and a graceful dupatta for elegant traditional dressing.', 2999, 4799, array['S','M','L','XL','XXL'], array['Cream','Gold'], array['/suits/ivory-straight-suit.jpg'], 10, 'published'),
('Magenta Party Wear Suit', 'magenta-party-wear-suit', 'Women', 'Pakistani Suits', 'Magenta party wear suit with festive embroidery and a bold color look for celebrations and special events.', 3199, 4999, array['S','M','L','XL'], array['Magenta','Pink'], array['/suits/maroon-palazzo-suit.jpg'], 8, 'published'),
('Aqua Blue Casual Lawn Suit', 'aqua-blue-casual-lawn-suit', 'Women', 'Pakistani Suits', 'Aqua blue casual lawn suit made for light comfort, easy movement, and simple everyday ethnic style.', 1799, 2899, array['XS','S','M','L','XL','XXL'], array['Aqua Blue'], array['/suits/sage-lawn-suit.jpg'], 24, 'published')
